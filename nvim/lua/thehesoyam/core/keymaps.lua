...
keymap.set("n", "<leader>+", "<C-a>") -- increase a number
...
keymap.set("n", "<leader>tp", ":tabp<CR>") --go to the prev tab
...
-- replaced with fugitive -- telescope git commands (not on youtube nvim video)
